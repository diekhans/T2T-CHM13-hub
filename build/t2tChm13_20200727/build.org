...
** chrUn and random now in primary assembly
cd lastz-unplaced
tawk '/Un/||/random/{print $1}' /hive/data/genomes/hg38/chrom.sizes> unplaces-random.chroms
chainFilter -q=$(cat unplaces-random.chroms | tr '\n' ',') ../../hg38Lastz/t2tChm13_20200727.hg38.over.chain.gz | bgzip --threads=64 -c >t2tChm13_20200727.hg38.unplaced-random.chain.gz
chainToPslBasic t2tChm13_20200727.hg38.unplaced-random.chain.gz stdout | pslToBed stdin hg38.unplaced-random.bed

  169 unplaces-random.chroms
  158 t2tChm13_20200727.hg38.unplaced-random.bed
buildBigBed bed12 t2tChm13_20200727  hg38.unplaced-random.bigBed  hg38.unplaced-random.bed
