...
buildBigBed  --as=../../../T2T-CHM13-hub/etc/rmskV2Bed.as --twoBit=../genome/HG002-X-v1.0.unmasked.2bit bed9+ HG002-X-v1.0 rmskV2.bigBed rmskV2.bed.gz
...
* @MarkD I realized the marker assisted mapping had dropped the chrX! :see_no_evil: I've updated the .wig files on globus:
team-curation/tracks/v1/coverage/*.markersandlength.cov.wig
