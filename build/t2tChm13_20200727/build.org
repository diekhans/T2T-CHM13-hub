...
* GENCODE transmap (drop)
** data
hgsql hg38 -Ne 'select * from gencodeAnnotV34' | cut -f 2- >data/gencodeAnnotV34.gp
hgsql hg38 -e 'select * from gencodeAttrsV34' | cut -f 2- >data/gencodeAttrsV34.tsv
genePredToFakePsl hg38 data/gencodeAnnotV34.gp data/gencodeAnnotV34.psl data/gencodeAnnotV34.cds
getRnaPred hg38 gencodeAnnotV34 all stdout | seqkit rmdup --quiet | bgzip  --threads=64 >data/gencodeAnnotV34.fa.gz


** transMap try 1
(pslMap -chainMapFile -swapMap -mapInfo=transMap/gencodeV24.hg38-t2tChm13_20200727.raw.mapinfo  data/gencodeAnnotV34.psl  ../hg38Lastz/hg38.t2tChm13_20200727.over.chain.gz stdout | \
pslRecalcMatch stdin ../genome/t2tChm13_20200727.2bit data/gencodeAnnotV34.fa.gz stdout | pslTSort >  transMap/gencodeV24.hg38-t2tChm13_20200727.raw.psl) >&log&

pslMapPostChain transMap/gencodeV24.hg38-t2tChm13_20200727.raw.psl stdout | pslTSort > transMap/gencodeV24.hg38-t2tChm13_20200727.chained.psl

sort -k 10,10 transMap/gencodeV24.hg38-t2tChm13_20200727.chained.psl | pslCDnaFilter -localNearBest=0.010 -minId=0.35 -minCover=0.15 -minQSize=20 -ignoreIntrons -repsAsMatch -ignoreNs -bestOverlap /dev/stdin transMap/gencodeV24.hg38-t2tChm13_20200727.filt.psl >& transMap/gencodeV24.hg38-t2tChm13_20200727.filt.out &
transMapPslToGenePred data/gencodeAnnotV34.gp transMap/gencodeV24.hg38-t2tChm13_20200727.filt.psl transMap/gencodeV24.hg38-t2tChm13_20200727.filt.gp -frameShifts=transMap/gencodeV24.hg38-t2tChm13_20200727.filt.fs.ts
# use r

* TransMap (refseq and gencode)
...
#  CLUSTER DOWN DUE TO FIRE, BUILD LOCAL
...
transMapBatch --directRun ./transMapBuildConf.py hg38 t2tChm13_20200727 ensembl all >&ens.log &
transMapBatch --directRun ./transMapBuildConf.py hg38 t2tChm13_20200727 refseq all >&ref.log &
