...
* gencodeBlat
- use gencode V3V to match CAT, only do protein code and lncRNAs
...
bedToBigBed -type=bed12+17 -tab -as=../../../T2T-CHM13-hub/etc/bigBlatPsl.as tmp/g.bigin2 ../genome/t2t-chm13-v1.0.sizes gencode.bigBlatPsl
ln -f gencode.bigBlatPsl  ../../../hub/t2t-chm13-v1.0/

# 2020-09-27 discovered error with filter command, so changed above

* update

** Mitchell Robert Vollger  4:34 PM
I pushed some updates to the .bb files in /team-segdups/WSSD_v1.0/ . It would be great if you could update them when you get a chance


New

** Lev  4:51 PM
Hi @Mark Diekhans, I have uploaded alpha satellite HOR, SF, and strand annotations for release v1.0 to the Globus under /team-satellites/AS_Annotation/release_v1.0/ Please add them to our assembly browser.
