...
* shortRnaSeqIntrons:
** download data from /team-genes/20200727/shortRnaSeq/raw-introns/
see ~/compbio/nanopore/projs/t2t-chm13/gene-annotation/t2t-chm13-gene-analysis/doc/t2tChm13_20200727.org
into shortRnaSeqIntrons/data
** 
...
** Lev ask for coloring to be left on when zoomed out
can't be done, as it falls into bigBed summary mode.

linkedFeaturesDraw
    bigBedDrawDense(tg, seqStart, seqEnd, hvg, xOff, yOff, width, font, color);
    # which does not  draw colors in summary mode
