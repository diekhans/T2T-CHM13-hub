...
* Ariel Gershman 
Hi Mark. I have a few more epigenetics tracks to be  added to the T2T v1.0 browser. Right now I am hosting  them here https://genome.ucsc.edu/s/agershman/t2t-chm13-v1.0_Epigenetics. Most of the bigwigs also contain GRCh38 Y, do I need to remake them without to  add them to the main T2T browser?


 also have revised methylation tracks that should replace the ones already on there
12:50
ok  perfect, I will get these setup

Hi  Mark here is a dropbox link to the browser tracks for  v1.0  https://www.dropbox.com/sh/0nu4bzfoyu3ojkg/AAAbCT6bl6YKwxo3RHaDRkDea?dl=0
Dropbox
Browser_Tracks
Shared with Dropbox
...
mappability_info.html goes with mappability_chm13v1_200bp.bw
