...
zcat t2t-chm13_k18.bed.gz |head | awk '{print $3-$2, length($4)}'
37 18
34 18
22 18
48 18
...
Hi Mark!
I just finished uploading the bedgraph for the PRO-seq reads (5A) aligned with STAR on Globus: /team-epigenetics/20200922-v1.0_chm13_PROseq/STAR_alignments/

I also added the duplicate PRO-seq read set (5B) in the same spot, including the sorted.bam, .bedgraph, and associated mapping stat files.
I only have one track description html up since all the information applies to both duplicate read sets, but I can make separate ones if you’d like!
And while I processed these duplicates separately and you can certainly display them as separate tracks, you can probably combine them into one larger dataset for a single track as well.
Let me know if any of this doesn’t make sense or if you’d like anything else from me at this tim


** Savannah Hoyt  11:21 AM
Hi @Mark Diekhans, would you be able to upload a track for me to the browser (whenever you have a chance, of course!) for PRO-seq reads aligned with Bowtie2 and then filtered with the unique 21-mers? I have a (fairly large) bedgraph & associated track description located on Globus at: /team-epigenetics/20200922-v1.0_chm13_PROseq/Bowtie2-aligned_Meryl-Intersections/

** FIMISH Ann's

** Can you help us upload the new cenAnnotation and cenRegions to v1.0?
